package com.wnview.camera2_calibration_opencv
...
import com.wnview.camera2_calibration_opencv.databinding.ActivityMainBinding
import com.wnview.camera2_calibration_opencv.dialogs.ErrorMessageDialog
import com.wnview.camera2_calibration_opencv.dialogs.StringDialog
import com.wnview.camera2_calibration_opencv.utils.bitmap2Mat
import com.wnview.camera2_calibration_opencv.utils.logMatDetails
import com.wnview.camera2_calibration_opencv.utils.saveImageToGallery
...
class MainActivity : AppCompatActivity() {
    ...
    private fun changeCameraSelect(cameraId: String) {
        ...
        Toast.makeText(this@MainActivity, "Camera changed to $selectedCameraId", Toast.LENGTH_SHORT).show()
    }
